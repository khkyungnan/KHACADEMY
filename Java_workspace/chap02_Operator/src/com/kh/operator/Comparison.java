...
public class Comparison {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 두개의 항 중 어느것이 더 큰 지, 더 작은지, 같은지,다른지의 여부를 판단함
		...
		int r = 5;
		System.out.println("p == r : " +(p == r)); //값이 5로 동일하기 때문에 true 출력
		
		//!= 두 항의 값이 다르면 참, 아니면 거짓을 반환 num!=5
	  //boolean isEqual1 = (5 != 10);
		boolean isEqual1 = p != q; //p와 q의 값이 다르게 나오기 때문에 true
		System.out.println("p != q : " + isEqual1);
		
		boolean isEqual2 = p != r ; //p와 r의 값이 같게 나오기 때문에 false
